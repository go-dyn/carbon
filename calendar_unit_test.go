...
func TestCarbon_VLunar(t *testing.T) {
	...
	for index, tt := range tests {
		t.Run(strconv.Itoa(index), func(t *testing.T) {
			assert.Equalf(t, tt.want, tt.args.c.VLunar().String(), "args{%v}", tt.args.c)
		})
	}
}

func TestCarbon_CreateFromVLunar(t *testing.T) {
	type args struct {
		year, month, day, hour, minute, second int
		isLeapMonth                            bool
	}
	...
	for index, tt := range tests {
		t.Run(strconv.Itoa(index), func(t *testing.T) {
			assert.Equalf(t, tt.want, CreateFromVLunar(tt.args.year, tt.args.month, tt.args.day, tt.args.hour, tt.args.minute, tt.args.second, tt.args.isLeapMonth).ToDateTimeString(), "args{%v}", tt.args)
		})
	}
}
