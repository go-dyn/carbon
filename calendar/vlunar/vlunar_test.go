...
func TestSolarToLunar(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromGregorian(time.Date(1900, 1, 1, 0, 0, 0, 0, time.Local))},
			want: "1899-12-01 00:00:00",
		},
		{
			args: args{FromGregorian(time.Date(2004, 11, 30, 0, 0, 0, 0, time.Local))},
			want: "2004-10-19 00:00:00",
		},
		{
			args: args{FromGregorian(time.Date(2022, 1, 1, 0, 0, 0, 0, time.Local))},
			want: "2021-11-29 00:00:00",
		},
		{
			args: args{FromGregorian(time.Date(2024, 1, 21, 1, 1, 1, 0, time.Local))},
			want: "2023-12-11 01:01:01",
		},
		{
		...
		{
			args: args{FromGregorian(time.Date(2022, 1, 25, 0, 0, 0, 0, time.Local))},
			want: "2021-12-23 00:00:00",
		},
		{
			args: args{FromGregorian(time.Date(2022, 6, 13, 0, 0, 0, 0, time.Local))},
...
func TestLunarToGregorian(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromLunar(1580, 12, 11, 0, 0, 0, false)},
			want: "1581-01-15 00:00:00",
		},
		{
...
func TestLunar_SolarTerm(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromGregorian(time.Date(2024, 3, 20, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 0, Name: "Xuân phân"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 4, 16, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 15, Name: "Thanh minh"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 5, 2, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 30, Name: "Cốc vũ"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 5, 16, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 45, Name: "Lập hạ"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 5, 29, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 60, Name: "Tiểu mãn"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 6, 11, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 75, Name: "Mang chủng"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 6, 27, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 90, Name: "Hạ chí"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 7, 10, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 105, Name: "Tiểu thử"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 7, 25, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 120, Name: "Đại thử"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 8, 8, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 135, Name: "Lập thu"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 8, 29, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 150, Name: "Xử thử"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 9, 10, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 165, Name: "Bạch lộ"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 9, 26, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 180, Name: "Thu phân"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 10, 9, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 195, Name: "Hàn lộ"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 10, 31, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 210, Name: "Sương giáng"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 11, 13, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 225, Name: "Lập đông"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 11, 22, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 240, Name: "Tiểu tuyết"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 11, 22, 0, 0, 0, 0, time.Local))},
		...
		{
			args: args{FromGregorian(time.Date(2024, 12, 6, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 255, Name: "Đại tuyết"},
		},
		{
			args: args{FromGregorian(time.Date(2024, 12, 26, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 270, Name: "Đông chí"},
		},
		{
			args: args{FromGregorian(time.Date(2025, 1, 8, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 285, Name: "Tiểu hàn"},
		},
		{
			args: args{FromGregorian(time.Date(2025, 1, 23, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 300, Name: "Đại hàn"},
		},
		{
			args: args{FromGregorian(time.Date(2025, 2, 3, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 315, Name: "Lập xuân"},
		},
		{
			args: args{FromGregorian(time.Date(2025, 2, 19, 0, 0, 0, 0, time.Local))},
			want: SolarTerm{Longitude: 330, Name: "Vũ Thủy"},
		},
		{
			args: args{FromGregorian(time.Date(2025, 3, 10, 0, 0, 0, 0, time.Local))},
...
func TestLunar_LuckyHour(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromGregorian(time.Date(2025, 3, 2, 0, 0, 0, 0, time.Local))},
			want: "110100101100",
		},
		{
			args: args{FromGregorian(time.Date(2025, 3, 3, 0, 0, 0, 0, time.Local))},
			want: "001101001011",
		},
		{
			args: args{FromGregorian(time.Date(2025, 3, 4, 0, 0, 0, 0, time.Local))},
			want: "110011010010",
		},
		{
			args: args{FromGregorian(time.Date(2025, 3, 5, 0, 0, 0, 0, time.Local))},
			want: "101100110100",
		},
		{
			args: args{FromGregorian(time.Date(2025, 3, 6, 0, 0, 0, 0, time.Local))},
			want: "001011001101",
		},
		{
			args: args{FromGregorian(time.Date(2025, 3, 7, 0, 0, 0, 0, time.Local))},
			want: "010010110011",
		},
	}
	for index, tt := range tests {
...
func TestLunar_Festival(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromGregorian(time.Date(2025, 4, 7, 0, 0, 0, 0, time.Local))},
			want: []Festival{{Day: 10, Month: 3, Name: "Giỗ Tổ Hùng Vương"}},
		},
		{
			args: args{FromGregorian(time.Date(2025, 5, 12, 0, 0, 0, 0, time.Local))},
		...
		{
			args: args{FromGregorian(time.Date(2026, 2, 10, 0, 0, 0, 0, time.Local))},
...
func TestLunar_Year(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromGregorian(time.Date(2025, 1, 28, 0, 0, 0, 0, time.Local))},
			want: 2024,
		},
		{
			args: args{FromGregorian(time.Date(2025, 1, 29, 0, 0, 0, 0, time.Local))},
			want: 2025,
		},
	}
	for index, tt := range tests {
...
func TestLunar_LeapMonth(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromGregorian(time.Date(2023, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 2,
		},
		{
			args: args{FromGregorian(time.Date(2025, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 6,
		},
		{
			args: args{FromGregorian(time.Date(2028, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 5,
		},
		{
			args: args{FromGregorian(time.Date(2031, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 3,
		},
		{
			args: args{FromGregorian(time.Date(2033, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 0,
		},
		{
			args: args{FromGregorian(time.Date(2036, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 6,
		},
		{
			args: args{FromGregorian(time.Date(2039, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 5,
		},
		{
			args: args{FromGregorian(time.Date(2042, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 2,
		},
		{
			args: args{FromGregorian(time.Date(2044, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 7,
		},
		{
			args: args{FromGregorian(time.Date(2047, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 5,
		},
		{
			args: args{FromGregorian(time.Date(2050, 7, 1, 0, 0, 0, 0, time.Local))},
			want: 3,
		},
	}
	for index, tt := range tests {
...
func TestLunar_Time(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{FromGregorian(time.Date(2020, 5, 1, 1, 1, 1, 0, time.Local))},
			want: "01:01:01",
		},
	}
	for index, tt := range tests {
